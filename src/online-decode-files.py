...
# session = ort.InferenceSession("./sherpa-onnx-streaming-zipformer-small-bilingual-zh-en-2023-02-16/encoder-epoch-99-avg-1.onnx", providers=["CUDAExecutionProvider"])
...
def main():
    ...
    wave_filename = args.sound_files[0]
    ...
    results = recognizer.get_result(s)
    print("Warm up")
